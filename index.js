...
//Below code goes over options for 'left' and its option tree
if(firstAnswer === 'left'){
    let secondAnswer = window.prompt(`You come across a stray cat. 
It scampers off down a small hole, just large enough for you to crawl through. 
Do you follow it, or continue on your path?`)

//Below code goes over options for 'follow' and its option tree
...
//Below code goes over options for 'continue' and its option tree
...
//Below code goes over options for 'right' and its option tree
else if(firstAnswer === 'right') {
    let secondAnswer = window.prompt(`You come across a snoring dragon. 
On the other side of him, you see a shiny chest of treasure. Another path would 
lead you away from the dragon altogether. Which path do you take?`)
//Below code goes over options for 'past the dragon' and its option tree
if(secondAnswer ==='past'){
   let thirdAnswer = window.prompt('he dragon wakes up and sits upright. You only have a moment to respond, to stay or run:')
    if(thirdAnswer ==='stay'){
...
//Below code goes over options for 'away from the dragon' and its option tree
